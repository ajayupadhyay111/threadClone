...
import { useTheme } from "@/components/ThemePorvider";
const ProtectedLayout = () => {
  ...
  return (
    <div
      onClick={() => dispatch(toggleheaderMenu(false))}
      className="mx-auto flex flex-col md:max-w-3xl min-w-full h-screen overflow-hidden  "
    >
      <nav className="flex sm:hidden justify-between items-center py-3 shadow-sm z-40">
        <div></div>
        <svg
          aria-label="Threads"
